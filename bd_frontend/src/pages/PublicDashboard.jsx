...
function PublicDashboard() {
  ...
  const fetchOrganizerStats = async (campId) => {
    ...
    try {
      ...
      const res = await axios.get(`${API_BASE_URL}/api/public/dashboard/organizer-stats?campId=${campId}`)
    ...
    const fetchAll = async () => {
      try {
        const [statsRes, chartsRes, regsRes, campsRes, listRes] = await Promise.all([
          axios.get(`${API_BASE_URL}/api/public/dashboard/stats`),
          axios.get(`${API_BASE_URL}/api/public/dashboard/charts`),
          axios.get(`${API_BASE_URL}/api/public/dashboard/recent-registrations`),
          axios.get(`${API_BASE_URL}/api/public/dashboard/upcoming-camps`),
          axios.get(`${API_BASE_URL}/api/public/blood-camps/all-list`),
        ])
        ...
        if (camps.length > 0) {
          ...
          setOrganizerLoading(true)
          const statsResOrg = await axios.get(`${API_BASE_URL}/api/public/dashboard/organizer-stats?campId=${camps[0].id}`)
  ...
  return (
    <main className="app-shell" style={{ overflowY: 'auto' }}>
      ...
      <div className="public-dash-container">
        <div className="public-dash-header">
          <div>
            <h1>Donation Dashboard</h1>
            <p>Live overview of blood donation camps and registrations.</p>
          </div>
          <Link to="/" className="public-dash-back">
